...
Las **redes neuronales artificiales** nacieron precisamente para atacar este tipo de problemas. Y aunque han existido desde los años 50, su dominio moderno llegó con tres ingredientes: grandes volúmenes de datos, poder de cómputo masivo (GPUs) y algoritmos de entrenamiento eficientes.
...
- Para problemas de negocio con datos tabulares: 1-3 capas ocultas con 64-256 neuronas suele ser suficiente.
